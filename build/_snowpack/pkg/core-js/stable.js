...
var FORCED$f = descriptors && fails(function () {
  // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
...
// https://tc39.es/ecma262/#sec-get-regexp.prototype.flags
if (FORCED$f) objectDefineProperty.f(RegExp.prototype, 'flags', {
  configurable: true,
  get: regexpFlags
});
...
_export({ target: 'String', proto: true, forced: WORKS_WITH_NON_GLOBAL_REGEX }, {
  matchAll: function matchAll(regexp) {
    ...
    if (regexp != null) {
      if (isRegexp(regexp)) {
        flags = String(requireObjectCoercible('flags' in RegExpPrototype$5
          ? regexp.flags
...
_export({ target: 'String', proto: true }, {
  replaceAll: function replaceAll(searchValue, replaceValue) {
    ...
    if (searchValue != null) {
      ...
      if (IS_REG_EXP) {
        flags = String(requireObjectCoercible('flags' in RegExpPrototype$6
          ? searchValue.flags
...
var __dirname = stable.__dirname;
var __filename = stable.__filename;
var clearImmediate = stable.clearImmediate;
var clearInterval = stable.clearInterval;
var clearTimeout = stable.clearTimeout;
export default stable;
var exports = stable.exports;
var global = stable.global;
var module = stable.module;
var queueMicrotask$1 = stable.queueMicrotask;
var require = stable.require;
var setImmediate = stable.setImmediate;
var setInterval = stable.setInterval;
var setTimeout$1 = stable.setTimeout;
export { __dirname, __filename, stable as __moduleExports, clearImmediate, clearInterval, clearTimeout, exports, global, module, queueMicrotask$1 as queueMicrotask, require, setImmediate, setInterval, setTimeout$1 as setTimeout };
